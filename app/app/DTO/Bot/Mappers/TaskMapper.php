...
class TaskMapper
{
    public static function taskFromModel(Task $model): TaskDTO
    {
        return new TaskDTO(
            ...
            check_remind_next_time: $model->check_remind_next_time?->toDateTimeString(),

            next_system_remind_at: $model->next_system_remind_at?->toDateTimeString(),

            last_shown_in_digest_at: $model->last_shown_in_digest_at?->toDateTimeString(),
