...
class Event extends Model
{
    ...
    #[Scope]
    protected function byEventTplId(Builder $query, int $templateId)
    {
    ...
    #[Scope]
    protected function whereDeadlineBetween(
        Builder $query, mixed $from, mixed $to
    ) {
    ...
    #[Scope]
    protected function wherePeriodOverlap(
        Builder $query, mixed $from, mixed $to
    ) {
