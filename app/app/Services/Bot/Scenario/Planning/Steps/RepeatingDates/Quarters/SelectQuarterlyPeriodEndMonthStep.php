...
final class SelectQuarterlyPeriodEndMonthStep implements StepInterface
{
    public const STEP_KEY = 'selectQuarterlyPeriodEndMonth';
    ...
    public function show(BotContext $context, ?string $error = null): void
    {
        ...
        $body = $this->textResolver->get(
            $type === 'task'
                ? 'choose_end_month_in_quarter'
                : 'choose_end_month_in_quarter_event',
            $messenger,
            $lang
        );
