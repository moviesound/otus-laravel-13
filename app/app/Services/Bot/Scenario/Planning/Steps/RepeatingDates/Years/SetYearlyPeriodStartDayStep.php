...
final class SetYearlyPeriodStartDayStep implements StepInterface
{
    public const STEP_KEY = 'setYearlyPeriodStartDay';
    ...
    private function handleMessage(BotContext $context, string $message): StepResultDTO
    {
        ...
        return StepResultFactory::switch(
            SelectYearlyPeriodEndMonthStep::STEP_KEY,
            [
                'start_day_in_year' => $day,
            ]
        );
    }
    ...
    public function show(BotContext $context, ?string $error = null): void
    {
        ...
        $month = $data['start_month_in_year'] ?? null;
