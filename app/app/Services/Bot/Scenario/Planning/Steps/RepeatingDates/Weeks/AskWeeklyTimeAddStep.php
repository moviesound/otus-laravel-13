...
final class AskWeeklyTimeAddStep implements StepInterface
{
    public const STEP_KEY = 'askWeeklyTimeAdd';
    ...
    private function handleMessage(BotContext $context, string $message): StepResultDTO
    {
        return match ($message) {
            ...
            'yes_one' =>
            StepResultFactory::switch(SetWeeklyCommonTimeStep::STEP_KEY),

            'yes_many' =>
            StepResultFactory::switch(SetWeeklyDifferentTimeStep::STEP_KEY),
    ...
    public function show(BotContext $context, ?string $error = null): void
    {
        ...
        $context->messenger?->sendMessage(
            $this->buildAnswer($context, $messenger, $lang, $data, $error),
            $buttons
        );
    }
