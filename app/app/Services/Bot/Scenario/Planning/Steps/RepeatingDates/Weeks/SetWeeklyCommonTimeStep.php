...
final class SetWeeklyCommonTimeStep implements StepInterface
{
    public const STEP_KEY = 'setWeeklyCommonTime';
    ...
    private function buildAnswer(
        ...
        $messenger = MessageContext::getMessengerAndLang($context)[0];
        $lang = MessageContext::getMessengerAndLang($context)[1];
