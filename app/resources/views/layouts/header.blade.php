<header
    class="sticky top-0 z-50 flex w-full bg-white drop-shadow dark:bg-boxdark"
>
    <div class="flex w-full items-center justify-end gap-4 px-4 py-4 md:px-6 2xl:px-11">
